    ...
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center px-6">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold text-[#1e293b]">Fathom Marine</h1>
          <p className="text-[#64748b]">Maritime Operations System</p>
        </div>

        <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-lg p-8 space-y-8">
          ...
          <form onSubmit={handleCreateAccount} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-[#f8fafc] border border-[#e2e8f0] rounded-lg px-6 py-3 text-[#1e293b] placeholder-[#94a3b8] focus:outline-none focus:ring-2 focus:ring-[#3b82f6] focus:border-transparent transition"
              />
            </div>
            ...
            <div>
              ...
              <Select value={role} onValueChange={setRole}>
                ...
                <SelectContent className="bg-[#ffffff] border border-[#e2e8f0]">
                  <SelectItem value="admin" className="text-[#1e293b]">Admin</SelectItem>
                  <SelectItem value="crew" className="text-[#1e293b]">Crew</SelectItem>
                </SelectContent>
              </Select>
            </div>
